...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        Dataset: "paf" | "pafw" | "pafa" | "mr" | "nyb" | "usps" | "ecaf" | "ecad" | "ab" | "herewe" | "heret" | "heresa" | "hereo" | "herena" | "heremeas" | "heremea" | "herem" | "herei" | "herehk" | "hereee" | "hereap" | "gnaf" | "kadaster" | "kartverket" | "sdfi" | "cannar" | "fodbosa" | "mois" | "upujp";
        /**
         * ISO Country Code (3)
         * @description   3 letter country code (ISO 3166-1)
         *
         ...
         * @enum {string}
         */
        usps_country: "American Samoa" | "Federated States of Micronesia" | "Guam" | "Marshall Islands" | "Northern Mariana Islands" | "Palau" | "Puerto Rico" | "United States" | "United States Virgin Islands";
        /**
         * ISO Country Code (3)
         * @description   3 letter country code (ISO 3166-1)
         *
         * @enum {string}
         */
        usps_country_iso: "ASM" | "FSM" | "GUM" | "MHL" | "MNP" | "PLW" | "PRI" | "USA" | "VIR";
        /**
         * ISO Country Code (2)
         * @description  2 letter country code (ISO 3166-1)
         *
         * @enum {string}
         */
        usps_country_iso_2: "AS" | "FM" | "GU" | "MH" | "MP" | "PR" | "PW" | "US" | "VI";
        /**
         * Language
         * @description Language represented by 2 letter ISO Code (639-1)
         *
        ...
        GbrGlobalAddress: {
            ...
            native: components["schemas"]["EcadAddress"] | components["schemas"]["EcafAddress"] | components["schemas"]["UspsAddress"] | components["schemas"]["HereAddress"] | components["schemas"]["GnafAddress"] | components["schemas"]["KadasterAddress"] | components["schemas"]["KartverketAddress"] | components["schemas"]["SdfiAddress"] | components["schemas"]["CannarAddress"] | components["schemas"]["FodbosaAddress"] | components["schemas"]["MoisAddress"] | components["schemas"]["UpujpAddress"];
            /**
        ...
        PostcodeResponse: {
             ...
             */
            result: (components["schemas"]["PafAddress"] | components["schemas"]["MrAddress"] | components["schemas"]["NybAddress"] | components["schemas"]["PafAliasAddress"] | components["schemas"]["WelshPafAddress"] | components["schemas"]["AbAddress"] | components["schemas"]["GbrGlobalAddress"])[];
            /** @enum {integer} */
            code: 2000;
            /** @enum {string} */
            message: "Success";
        ...
        GbrCleanseMatch: {
            ...
            match: components["schemas"]["PafAddress"] | components["schemas"]["MrAddress"] | components["schemas"]["NybAddress"] | components["schemas"]["PafAliasAddress"] | components["schemas"]["WelshPafAddress"] | components["schemas"]["UsaCassVerifiedAddress"];
        ...
        UsaVerifyMatch: {
            ...
            /** @description Nearest matching address */
            match: components["schemas"]["UsaCassVerifiedAddress"] | components["schemas"]["PafAddress"] | components["schemas"]["MrAddress"] | components["schemas"]["NybAddress"] | components["schemas"]["PafAliasAddress"] | components["schemas"]["WelshPafAddress"];
            /** @description The number of addresses we matched to the input. We return the closest match by default. */
            count: number;
            /** @description A score represented as number between 1 and 0. Fit compares the address elements present in your query against the matching address elements. It does not incorporate elements you have not presented in the score. A partial address (e.g. 12 Pye Green Road) will have a fit of 1 even though it is missing post town and postcode. Its confidence score will be less than 1 however because it is missing some crucial elements. */
            fit: number;
        ...
        VerifyResponse: {
            ...
            /** @enum {string} */
            message: "Success";
            result: components["schemas"]["UsaVerifyMatch"] | components["schemas"]["UsaVerifyNoMatch"];
        };
        /**
         * Address Suggestion
        ...
        GbrResolveAddressResponse: {
            ...
            /** @enum {string} */
            message: "Success";
            result: components["schemas"]["PafAddress"] | components["schemas"]["MrAddress"] | components["schemas"]["WelshPafAddress"] | components["schemas"]["PafAliasAddress"] | components["schemas"]["NybAddress"] | components["schemas"]["AbAddress"] | components["schemas"]["GbrGlobalAddress"];
        };
        /**
         * Global Address
        ...
        UsaGlobalAddress: {
            ...
            native: components["schemas"]["EcadAddress"] | components["schemas"]["EcafAddress"] | components["schemas"]["PafAddress"] | components["schemas"]["MrAddress"] | components["schemas"]["NybAddress"] | components["schemas"]["PafAliasAddress"] | components["schemas"]["WelshPafAddress"] | components["schemas"]["AbAddress"] | components["schemas"]["HereAddress"] | components["schemas"]["GnafAddress"] | components["schemas"]["KadasterAddress"] | components["schemas"]["KartverketAddress"] | components["schemas"]["SdfiAddress"] | components["schemas"]["CannarAddress"] | components["schemas"]["FodbosaAddress"] | components["schemas"]["MoisAddress"] | components["schemas"]["UpujpAddress"];
        };
        ...
        AddressResponse: {
            ...
            result: {
                ...
                hits: (components["schemas"]["PafAddress"] | components["schemas"]["MrAddress"] | components["schemas"]["NybAddress"] | components["schemas"]["WelshPafAddress"] | components["schemas"]["PafAliasAddress"] | components["schemas"]["AbAddress"])[];
                /** Format: int32 */
                total: number;
                /**
                 * Format: int32
